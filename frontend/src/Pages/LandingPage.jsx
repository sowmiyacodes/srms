      ...
      <main className="relative z-10 flex-grow flex flex-col items-center justify-center px-4 py-12">
        <div className="text-center mb-10 max-w-xl animate-fade-in">
          <p className="text-slate-300 mt-3 text-sm sm:text-base leading-relaxed">
            Select your authorization portal below. Please enter valid credentials to access your administrative workspace or faculty advisory dashboard.
          </p>
        </div>

        {/* Portals Grid */}
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl w-full px-4 animate-slide-up">
          {/* Staff Login Card */}
          <div 
